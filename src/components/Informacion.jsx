...
// const Informacion = ({tituloSecundario}) => {
    return (
        <section>
            <h2>Conceptos Básicos de React {props.anioActualProps}</h2>
            ...
            <ol className="list-group">
                <li className="list-group-item">Componentes: </li>
                <li className="list-group-item">Propiedades (Props): </li>
                <li className="list-group-item">Estado (State): </li>
                <li className="list-group-item">Ciclo de Vida (Lifecycle): </li>
                <li className="list-group-item">JSK (JavaScript XML): </li>
            </ol>
        </section>
    );
};
